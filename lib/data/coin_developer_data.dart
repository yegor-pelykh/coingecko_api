...
class CoinDeveloperData {
  ...
  CoinDeveloperData.fromJson(Map<String, dynamic> json)
      : this.forks = Convert.toInt(json['forks']),
        ...
        this.pullRequestContributors = Convert.toInt(json['pull_request_contributors']),
        this.codeAdditionsDeletions4Weeks = json.containsKey('code_additions_deletions_4_weeks')
            ? CoinDeveloperDataCodeChanges.fromJson(json['code_additions_deletions_4_weeks'])
            : null,
